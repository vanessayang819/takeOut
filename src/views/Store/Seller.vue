<template>
  <div class="seller-info">
    ...
    <div class="position container">
      ...
      <p class="address describe">{{ poiInfo.address }}</p>
    ...
    <div class="delivery-time container">
      <span class="icon"><i class="iconfont">&#xe62f;</i></span>
      <span class="describe"
        >配送时间: {{ poiInfo.shopping_time_start }} -
        {{ poiInfo.shopping_time_end }}</span
      >
    </div>
    <!--公告-->
    <div class="notification container" v-if="poiInfo.bulletin">
      <span class="icon"><i class="iconfont">&#xe6aa;</i></span>
      <span class="describe ellipsis">{{ poiInfo.bulletin }}</span>
      <span class="entry-icon icon"><i class="iconfont">&#xe63f;</i></span>
    </div>
    <!--商家服务-->
    ...
    <div class="discount">
      <ul>
        <li v-for="(discount, index) in poiInfo.discounts2" :key="index">
          <span
            class="active-icon"
            :style="{ backgroundImage: 'url(' + discount.icon_url + ')' }"
          ></span>
